...
namespace TestareManual
{
    ...
    public class Permits2
    {
        ...
        public void Permit2()
        {
            ...
            //BrowserWindow brows = BrowserWindow.Launch("http://mmip.dotgov.md");
            ...
            //string Send1 = "div.mwnd-body > div:nth-child(2) > div:nth-child(1) table > tbody > tr > td > div:nth-child(3) > a:nth-child(1)";
        ...
        public void changeRole(UITestControl parent, string name)
        {
            ...
            chRole.WaitForControlExist(1000);
            Mouse.Click(chRole);
        }
